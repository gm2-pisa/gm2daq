...
int AMC13_lib::AMC13_rg(cms::AMC13 *amc13)
{
...
int AMC13_lib::AMC13_Setup(cms::AMC13* amc13)
{
...
int AMC13_lib::AMC13_Reset(cms::AMC13 *amc13)
{
...
int AMC13_lib::AMC13_Write(cms::AMC13 *amc13)
{
...
int AMC13_lib::AMC13_Read(cms::AMC13 *amc13)
{
...
void AMC13_lib::AMC13_Dummy()
{
  
  printf("AMC13_lib printout\n");
