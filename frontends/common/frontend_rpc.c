 ...
 * @date    Last-Updated: Wed May 13 11:05:43 2015 (-0400)
 *          By : Data Acquisition
 *          Update #: 62 
 * @version $Id$
 * 
...
//#include "../MasterGM2/rpc_g2.h"
#include "../MasterGM2/rpc_g2.h"
static HNDLE rpc_master_hndle;
static char *rpc_master_name = "MasterGM2";
...
INT frontend_rpc_init()
{
  ...
  printf("arm sampling logic status = %d\n",status);
  if ( status != RPC_SUCCESS )
    {
