...
<<<<<<< HEAD
 * @date    Last-Updated: Thu Apr 17 15:54:11 2014 (-0400)
=======
 * @date    Last-Updated: Fri Jan 24 11:26:05 2014 (-0500)
>>>>>>> origin/develop
 *          By : Data Acquisition
 *          Update #: 235 
 * @version $Id$
...
int calo_simulator_init()
{
  ...
  /** Trigger thread **/
  calo_simulator_thread_info.data_size = CALO_N_SEGMENTS*WAVEFORM_LENGTH; // 35 calorimeters x 500 MHz x 737 us
