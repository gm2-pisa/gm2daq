...
# Compilers
NVCC       := $(CUSASYS)/bin/nvcc 

# Includes
INCLUDES  += -I. -I$(CUSASYS)/include  -I$(CUSASYS)/NVIDIA_GPU_Computing_SDK/shared/inc -I$(CUSASYS)/NVIDIA_GPU_Computing_SDK/C/common/inc
...
NVCCFLAGS += $(INCLUDES) --compiler-options -fno-strict-aliasing \
	-arch compute_11
...
ifeq ($(OSTYPE),linux64)
       LDFLAGS       += -L$(CUSASYS)/lib64 -L$(CUSASYS)/NVIDIA_GPU_Computing_SDK/shared/lib -L$(CUSASYS)/NVIDIA_GPU_Computing_SDK/C/lib -L$(CUSASYS)/NVIDIA_GPU_Computing_SDK/C/common/lib/linux  -lcuda -lcudart -lcutil_x86_64  -lshrutil_x86_64 
else
       LDFLAGS      += -L$(CUSASYS)/lib -L$(CUSASYS)/NVIDIA_GPU_Computing_SDK/shared/lib -L$(CUSASYS)/NVIDIA_GPU_Computing_SDK/C/lib -L$(CUSASYS)/NVIDIA_GPU_Computing_SDK/C/common/lib/linux -lcuda -lcudart -lcutil  -lshrutil
endif
