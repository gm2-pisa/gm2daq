 ...
 * @date    Last-Updated: Fri Oct  2 10:56:42 2015 (-0500)
 *          By: Data Acquisition
 *          Update #: 42
 * @version $Id$
 * 
...
//EXTERN GPU_THREAD_COPYHOST2DEVICE_INFO gpu_thread_copyHost2Device_info;
...
// 0x20000000 = 512 MB
#define GPU_OBUF_SIZE       0x20000000
// 0x20000000 = 32 MB
...
extern "C" {
#endif
  EXTERN int cuda_init_g2(); 
  EXTERN void cuda_g2_bor_kernel(); 
  EXTERN void cuda_g2_run_kernel( unsigned char *gpu_idata, unsigned char *gpu_odata, int16_t *cpu_data );
  //EXTERN unsigned int cuda_g2_fetch_waveforms(unsigned char *gpu_odata, unsigned char *buf);
  //EXTERN unsigned int cuda_g2_fetch_islands  (unsigned char *gpu_odata, unsigned char *buf);
#ifdef __cplusplus
}
#endif 
